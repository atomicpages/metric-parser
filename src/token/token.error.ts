...
export namespace TokenError {
    ...
    export const missingValueBefore: ErrorValue = { code: 0x0122, text: 'missing value before `{0}` token' };
    export const missingValueAfter: ErrorValue = { code: 0x0123, text: 'missing value after `{0}` token' };
