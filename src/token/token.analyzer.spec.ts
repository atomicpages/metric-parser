...
describe("case: parse with invalid data", () => {
  it("should throw an invalidToken error with invalid operator", () => {
    ...
    expect(() => tokenAnalyzer.parse())
      ...
      .and.satisfy(
        (error: ParserError) =>
          error.parserStack.col === 1 && error.parserStack.line === 0,
      )
  ...
  it("should throw an invalidToken error with invalid number value", () => {
    ...
    expect(() => tokenAnalyzer.parse())
      ...
      .and.satisfy(
        (error: ParserError) =>
          error.parserStack.col === 5 && error.parserStack.line === 0,
      )
      .and.to.have.property("code", TokenError.invalidToken.code);
  });
  ...
  it("should throw an missingValueAfter error with invalid expression", () => {
    ...
    expect(() => tokenAnalyzer.parse())
      ...
      .and.satisfy(
        (error: ParserError) =>
          error.parserStack.col === 4 && error.parserStack.line === 0,
      )
  ...
  it("should throw an invalidTwoOperator error with duplicated operator expression", () => {
    ...
    expect(() => tokenAnalyzer.parse())
      ...
      .and.satisfy(
        (error: ParserError) =>
          error.parserStack.col === 2 && error.parserStack.line === 0,
      )
  ...
  it("should throw an bracketMustBeOpened error", () => {
    ...
    expect(() => tokenAnalyzer.parse())
      ...
      .and.satisfy(
        (error: ParserError) =>
          error.parserStack.col === 3 && error.parserStack.line === 0,
      )
  ...
  it("should throw an emptyToken error with empty value", () => {
    ...
    expect(() => tokenAnalyzer.parse())
      ...
      .and.satisfy(
        (error: ParserError) =>
          error.parserStack.col === 0 && error.parserStack.line === 0,
      )
